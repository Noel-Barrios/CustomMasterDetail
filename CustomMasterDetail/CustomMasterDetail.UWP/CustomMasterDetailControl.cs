...
[assembly: ExportRenderer(typeof(MainPage), typeof(CustomMasterDetailControl))]
namespace CustomMasterDetail
{
    public class CustomMasterDetailControl : IVisualElementRenderer, IToolbarProvider, ITitleProvider, ITitleIconProvider, ITitleViewProvider, IToolBarForegroundBinder
    {
        Page _master;
        Page _detail;
        bool _showTitle;
...
#pragma warning restore
        ...
        void UpdateBounds()
        {
            Windows.Foundation.Size masterSize = 25;
            Windows.Foundation.Size detailSize = Control.DetailSize;

            Element.MasterBounds = new Rectangle(0, 0, 25, masterSize.Height);
